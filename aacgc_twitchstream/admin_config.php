...
if (isset($_POST['twitch_showoffline'])) 
{$pref['twitch_showoffline'] = 1;}
else
{$pref['twitch_showoffline'] = 0;}
...
<tr>
<td style='width:30%' class='forumheader3'><b>".ATWS_16.":</b></td>
<td colspan=2 class='forumheader3'>".($pref['twitch_showoffline'] == 1 ? "<input type='checkbox' name='twitch_showoffline' value='1' checked='checked' />" : "<input type='checkbox' name='twitch_showoffline' value='0' />")."</td>
</tr>
<tr>
